...
story_path="sumdata/train/story.txt"
...
######### Changes for this random summary ###########################
def build_dataset_demo(step,word_dict,article_max_len,summary_max_len,toy=False,demo_sent=None):
    if step == "demo":
        article_list=[demo_sent]
